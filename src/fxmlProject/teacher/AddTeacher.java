...
public class AddTeacher {
    ...
    private void addTeacher() throws SQLException, IOException {
        ...
        PreparedStatement selectTeacherEmailStatement = connection.prepareStatement("select profesor.ProfesorId from profesor where profesor.Email = ?");
