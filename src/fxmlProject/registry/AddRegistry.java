...
public class AddRegistry {
    ...
    private void initialize() throws SQLException {
        ...
        ResultSet result = selectFromProfileStatement.executeQuery("select Name from grouptype");
        while (result.next())
    ...
    private void setTeacherList() throws SQLException {
        ...
        ResultSet result = selectTeacherStatement.executeQuery("select profesor.Name,profesor.Email from profesor");
        while (result.next())
